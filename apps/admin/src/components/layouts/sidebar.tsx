...
const navigation = [
  ...
  },
  {
    ...
    icon: DollarSign,
    children: [
      { name: 'Payouts', href: '/dashboard/financial/payouts' },
      { name: 'Payout History', href: '/dashboard/financial/payouts/history' },
      { name: 'Commissions', href: '/dashboard/financial/commissions' },
      { name: 'Refunds', href: '/dashboard/financial/refunds' },
      { name: 'Transactions', href: '/dashboard/financial/transactions' },
